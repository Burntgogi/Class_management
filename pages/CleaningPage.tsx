...
import { ArrowLeft, Home, Settings as SettingsIcon, Shuffle } from 'lucide-react';
...
export const CleaningPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.18),_transparent_26%),linear-gradient(180deg,#eff6ff_0%,#f8fafc_38%,#eef4ff_100%)] print:bg-white">
      <div className="mx-auto max-w-7xl animate-fade-in px-4 py-6 print:bg-white md:px-8 md:py-8">
        ...
        <section className={`mt-4 overflow-hidden rounded-[36px] border border-white/70 bg-white/80 shadow-[0_35px_90px_-40px_rgba(15,23,42,0.35)] backdrop-blur print:bg-white ${appState === 'result' ? 'no-print' : ''}`}>
